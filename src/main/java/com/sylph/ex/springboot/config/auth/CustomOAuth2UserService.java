...
import com.sylph.ex.springboot.config.auth.dto.OAuthAttributes;
import com.sylph.ex.springboot.config.auth.dto.SessionUser;
import com.sylph.ex.springboot.domain.user.User;
import com.sylph.ex.springboot.domain.user.UserRepository;
